...
urlpatterns = [
    ...
    url(r'^sshlog/$',views.get_log, name="ssh_log_list"),
    url(r'host/(\d+)/',views.connect_host),
    url(r'^vuestudey/',views.vue_study),
    url(r'^upload_ajax/',views.upload_host),
